...
class make_db:
    ...
    def make_vector_db(self, pdf_paths):
        ...
        #print(f"\n summary文档中培训提议里面详细的内容：{retriever.vectorstore.similarity_search("培训提议")[0]} \n")
        print(f"\n summary文档中培训提议里面详细的内容：{retriever.vectorstore.similarity_search("培训提议")} \n")
        print(f"\n 父文档中培训提议里面详细的内容: {retriever.get_relevant_documents("培训提议")}, \n")
