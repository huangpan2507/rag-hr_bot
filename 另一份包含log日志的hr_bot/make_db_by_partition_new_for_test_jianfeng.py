...
class make_db:
    def __init__(self) -> None:
        ...
        self._pdf_path = "/mnt/AI/hr_material_test_jianfeng/"
        #self._img_path = "/mnt/AI/Papers/figure/"
        self._img_path = "/mnt/AI/Papers/figure_test_jianfeng/"
        #self._persist_directory = '/mnt/AI/data_base/vector_db/chroma_partition'
        self._persist_directory = '/mnt/AI/data_base/vector_db/chroma_new_jianfeng'
    ...
    def make_vector_db(self, pdf_paths):
        ...
        print(f"raw_pdf_elements, {raw_pdf_elements}")
        # Categorize by type
